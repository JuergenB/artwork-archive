...
export function toExportLog(fields: Record<string, unknown>, id: string): ExportLog {
  return {
    ...
    artistXlsxUrl: asString(fields["Artist XLSX URL"]),
    artworkXlsxUrl: asString(fields["Artwork XLSX URL"]),
    imageAuditSummary: asString(fields["Image Audit Summary"]),
    imageLinksExpireAt: asString(fields["Image Links Expire At"]),
    aaTemplateRevision: asString(fields["AA Template Revision"]),
